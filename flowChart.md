...
flowchart TD
    ...
    subgraph Preprocessing
      B1[OFpre/main_pre.py: Write yTopParams.in using new sample<br/>(new geometry parameters)]
    ...
    subgraph Simulation
      C1[OFcase/system: Mesh generation<br/>(blockMesh & decomposePar)]
    ...
    subgraph PostProcessing
      ...
      D2[Compute boundary layer parameters<br/>(β, Reₜ, δ*, etc.) & objective]
    ...
    subgraph Optimization_Update
      E1[gpOptim/gpOpt.py: Update gpList.dat<br/>(append sample & objective)]
      E2[Check convergence criteria<br/>(BO_update_convergence())]
      D3 --> E1
      E1 --> E2
      E2 -- Not Converged --> B1
    end
